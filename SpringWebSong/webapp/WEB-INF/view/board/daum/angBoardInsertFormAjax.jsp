...
// 				Editor.save();
				...
				$.ajax({
					url : "/board/daum/angBoardInsertProcAjax.do",
					method : "post",
					data : param,
					dataType : "json",
					success : function(data) {
						...
						location.href="/board/daum/angBoardDetailView.do?no=" + data.boardNo;
					}
				});
	...
	<div>
		...
		<form name="tx_editor_form" id="tx_editor_form" method="post"  accept-charset="utf-8">
			<table width="100%">
				...
				<tr>
					<td colspan="2">
						<button type="button" id="save" value="저장" onclick="insertBoard()">저장</button>
